...
int main( int argc, char** argv ) {
    ...
    // window
    WindowConfiguration wconf{ 1280, 800, "Chapter 11: Ray Tracing Basics", &MemoryService::instance()->system_allocator};
    ...
    // Load frame graph
    {
        ...
        frame_renderer.add_render_pass( "hdr_color_copy_pass", rnewa( chapter11::HDRColorCopyPass, allocator, 64 ) );
        frame_renderer.add_render_pass( "bloom_pass", rnewa( chapter11::BloomPass, allocator, 64 ) );
        frame_renderer.add_render_pass( "ray_tracing_test_pass", rnewa( RayTracingTestPass, allocator, 64 ) );
