...
namespace VertexComponentFormat {
    enum Enum {
        Float, Float2, Float3, Float4, Mat4, Byte, Byte4N, UByte, UByte4, UByte4N, Short2, Short2N, Short4, Short4N, Uint, Uint2, Uint4, Count
    };
...
namespace ResourceUpdateType {
    ...
    enum Enum {
        Buffer, Image, Pipeline, Sampler, DescriptorSetLayout, DescriptorSet, RenderPass, Framebuffer, ShaderState, ImageView, PagePool, PipelineLayout, BLAS, TLAS, Count
    };

    static const char* s_value_names[] = {
        "Buffer", "Image", "Pipeline", "Sampler", "DescriptorSetLayout", "DescriptorSet", "RenderPass", "Framebuffer", "ShaderState", "ImageView", "PagePool", "PipelineLayout", "BLAS", "TLAS"
    };
...
namespace RayTracingGroup {

    enum Enum {
        Raygen, Miss, Hit, Count
    };
