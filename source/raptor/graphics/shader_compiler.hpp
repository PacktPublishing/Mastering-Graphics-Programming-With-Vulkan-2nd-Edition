...
struct ShaderCompiler
{
    ...
    static                  void read_source_from_file_and_add_hashes( ShaderCompilationStage& shader_stage, ShaderLanguage language, StringBuffer& shader_buffer, ArenaAllocator* temp_allocator );
    static                  bool compile_and_cache_shader( ShaderCompilationStage& compilation_stage, Span<const u32>& spirv_bytecode, cstring binary_data_folder, ArenaAllocator* temp_allocator,
                                                           ...
                                                           bool use_cache, ShaderLanguage language, bool ignore_layout, bool& shader_changed );
