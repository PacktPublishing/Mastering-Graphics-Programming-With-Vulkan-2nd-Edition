...
int main( int argc, char** argv ) {
    ...
    frame_renderer.set_upscale_settings( { .render_scale = 0.666f, .enabled = true } );
    ...
    // Create scene resources
    {
        ...
        chapter12::scene_mesh_instances_ssbo = gpu.create_buffer( {
            .size = sizeof( chapter12::MeshData ) * render_scene.mesh_instances.size,
        ...
        ds_creation.ssbos = {
            {.buffer = chapter12::scene_mesh_instances_ssbo,
        ...
        //chapter12::scene_ds = gpu.create_descriptor_set( ds_creation );
    }
    ...
    while ( !window.requested_exit ) {
...

        {
            ...
            if ( update_mesh_data )
            {
                ...
                Buffer* mesh_buffer = gpu.get_buffer( chapter12::scene_mesh_instances_ssbo );
                RASSERT( mesh_buffer );
                chapter12::MeshData* mesh_data = ( chapter12::MeshData* )mesh_buffer->mapped_data;
                if ( mesh_data ) {
                    ...
                    gpu.flush_buffer( chapter12::scene_mesh_instances_ssbo, 0, sizeof( chapter12::MeshData ) * render_scene.mesh_instances.size );
                }
            }
    ...
    gpu.destroy_descriptor_set( chapter12::scene_ds );
    gpu.destroy_buffer( chapter12::scene_mesh_instances_ssbo );
