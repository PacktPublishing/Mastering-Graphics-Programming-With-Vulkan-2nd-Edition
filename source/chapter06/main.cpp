...
int main( int argc, char** argv ) {
    ...
    // window
    WindowConfiguration wconf{ 1280, 800, "Chapter 6: GPU-Driven Animation", &MemoryService::instance()->system_allocator};
    ...
    // Load frame graph
    {
        ...
        frame_renderer.add_render_pass( "hdr_color_copy_pass", rnewa( chapter6::HDRColorCopyPass, allocator, 64 ) );
        frame_renderer.add_render_pass( "bloom_pass", rnewa( chapter6::BloomPass, allocator, 64 ) );
    ...
    // Create scene resources
    {
        ...
        chapter6::scene_mesh_instances_ssbo = gpu.create_buffer( {
            .size = sizeof( chapter6::MeshData ) * render_scene.mesh_instances.size,
        ...
        ds_creation.ssbos = {
            {.buffer = chapter6::scene_mesh_instances_ssbo,
        ...
        //chapter6::scene_ds = gpu.create_descriptor_set( ds_creation );
    }
    ...
    while ( !window.requested_exit ) {
...

        {
            ...
            if ( update_mesh_data )
            {
                ...
                Buffer* mesh_buffer = gpu.get_buffer( chapter6::scene_mesh_instances_ssbo );
                RASSERT( mesh_buffer );
                chapter6::MeshData* mesh_data = ( chapter6::MeshData* )mesh_buffer->mapped_data;
                if ( mesh_data ) {
                    ...
                    gpu.flush_buffer( chapter6::scene_mesh_instances_ssbo, 0, sizeof( chapter6::MeshData ) * render_scene.mesh_instances.size );
                }
            }
    ...
    gpu.destroy_descriptor_set( chapter6::scene_ds );
    gpu.destroy_buffer( chapter6::scene_mesh_instances_ssbo );
